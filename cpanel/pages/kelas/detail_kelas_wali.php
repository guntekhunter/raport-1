											...
											?>
												<tr>
													...
													<td>
														...
														<input type="button" class="btn btn-danger" name="Lihat" value="Lihat" onclick="window.location='?page=vwRpSw&tid=<?php echo $b['nis']; ?>' ">
													</td>
												</tr>
											<?php $no++;
											} ?>
											...
											?>
												<tr>
													...
													<td><input type="button" class="btn btn-primary" name="submit" value="Edit" onclick="window.location='?page=edSk&tid=<?php echo $s['id_siswa']; ?>' ">
														<input type="button" class="btn btn-danger" name="reset" value="Hapus" onclick="window.location='?page=dlSk&tid=<?php echo $s['id_sikap']; ?>' ">
													</td>
												</tr>
											<?php $no++;
											} ?>
											...
											?>
												<tr>
													...
													<td><input type="button" class="btn btn-primary" name="submit" value="Edit" onclick="window.location='?page=edEk&tid=<?php echo $s['id_ekskul']; ?>' ">
														<input type="button" class="btn btn-danger" name="reset" value="Hapus" onclick="window.location='?page=dlEk&tid=<?php echo $s['id_ekskul']; ?>' ">
													</td>
												</tr>
											<?php $no++;
											} ?>
											...
											?>
												<tr>
													...
													<td><input type="button" class="btn btn-primary" name="submit" value="Edit" onclick="window.location='?page=edPr&tid=<?php echo $s['id_prestasi']; ?>' ">
														<input type="button" class="btn btn-danger" name="reset" value="Hapus" onclick="window.location='?page=dlPr&tid=<?php echo $s['id_prestasi']; ?>' ">
													</td>
												</tr>
											<?php $no++;
											} ?>
											...
											?>
												<tr>
													...
													<td><input type="button" class="btn btn-primary" name="submit" value="Edit" onclick="window.location='?page=edHr&tid=<?php echo $z['id_hadir']; ?>' ">
														<input type="button" class="btn btn-danger" name="reset" value="Hapus" onclick="window.location='?page=dlHr&tid=<?php echo $z['id_hadir']; ?>' ">
													</td>
												</tr>
											<?php $no++;
											} ?>
